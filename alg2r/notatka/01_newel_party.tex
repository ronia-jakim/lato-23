...
\indent 2. Udowodnimy wersję ogólniejszą: jeśli $\phi:K_1\to K_2$ jest izomorfizmem nad ciałem i $f_i\in K_i[X]$ jest wielomianem stopnia $>0$, $\phi(f_1)=f_2$, to wtedy istnieje $\psi:L_1\to L_2$ izomorfizm nad ciałami rozkładu tych $K_i$.