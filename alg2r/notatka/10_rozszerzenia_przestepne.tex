...
\begin{itemize}
    ...
    \item[\PHtunny] \important{wymiar przestępny} $B$ nad $K$ $trdeg_K(B)$ to moc jakiejkolwiek bazy przestępnej zbioru $B$ nadk $K$.
\end{itemize}
\end{bbox}

Gdy $K=F$ jest ciałem prostym, pomijamy je w $acl_K,trdeg_K$. {\large\color{orange}CO???}
