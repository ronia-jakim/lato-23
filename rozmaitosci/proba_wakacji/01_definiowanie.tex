...
Dla mapy $(U, \phi)$ takiej, że $p\in U$ i $\phi(p)=0\in\R^n$ mówimy, że jest \acc[i]{mapą wokół $p$}.

Mapy nazywa się też czasem \acc[i]{lokalnymi współrzędnymi} na $M$ lub \acc[i]{lokalną parametryzacją} $M$.
